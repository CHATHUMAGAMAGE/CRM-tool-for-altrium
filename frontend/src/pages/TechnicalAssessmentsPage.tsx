...
function TechnicalAssessmentsPage({
  dashboardMode = false,
}: Props) {
  const navigate =
    useNavigate()
      ...
      try {
        ...
        setError(
          loadError instanceof
            Error
            ? loadError.message
            : 'Unable to load technical assessments.',
        )
      } finally {
        setIsLoading(false)
      }
    ...
    >
      ...
      >
        <Box>
          ...
          >
            {dashboardMode
              ? 'Review assigned assessments and continue your pending technical work.'
              : 'Review, complete and track the technical assessments assigned to you.'}
          </Typography>
        </Box>
...
export default TechnicalAssessmentsPage